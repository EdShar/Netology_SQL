CREATE TABLE public.music_genre (
	id_genre int8 NOT NULL GENERATED ALWAYS AS IDENTITY,
...
CREATE TABLE public.musician_performer (
	id_musician int8 NOT NULL GENERATED ALWAYS AS IDENTITY,
...
CREATE TABLE public.album (
	id_album int8 NOT NULL GENERATED ALWAYS AS IDENTITY,
...
CREATE TABLE public.track (
	id_track int8 NOT NULL GENERATED ALWAYS AS IDENTITY,
	...
	CONSTRAINT track_fk_1 FOREIGN KEY (id_track,id_collection) REFERENCES public.track_collection(id_track,id_collection)
);
...
CREATE TABLE public.music_collection (
	id_collection int8 NOT NULL GENERATED BY DEFAULT AS IDENTITY,
